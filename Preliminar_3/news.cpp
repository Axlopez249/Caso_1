...
public:
    vector<News *> getRecords(string Search_word)
    {
        ...
        string url = "https://newsapi.org/v2/everything?q=" + Search_word +"&from=2023-08-29&sortBy=popularity&apiKey=58ea7c7466f544838fe434eaf6af64f0";
